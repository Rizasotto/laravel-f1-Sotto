    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="checkout-container">
            ...
            <div class="checkout-form">
                <form action="<?php echo e(route('order.confirm', $order)); ?>" method="POST" id="checkoutForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="checkout-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" required value="<?php echo e(auth()->user()->email ?? ''); ?>">
                        </div>
                    ...
                    <div class="checkout-buttons">
                        ...
                        <a href="<?php echo e(route('cart.index')); ?>" class="btn-back" style="display: block; text-align: center; text-decoration: none;">Back to Cart</a>
                    </div>
                </form>
            </div>
            ...
            <div class="order-summary">
                ...
                <div class="summary-items">
                    ...
                    <div class="summary-item">
                        <div class="item-name"><?php echo e(Str::limit($item->artwork->title, 25)); ?> (x<?php echo e($item->quantity); ?>)</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel-f1-Sotto - Copy\resources\views/checkout/index.blade.php ENDPATH**/ ?>