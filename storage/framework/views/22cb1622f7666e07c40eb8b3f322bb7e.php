...
<?php $__env->startSection('title', 'Artist Dashboard'); ?>
...
<div class="dashboard-wrapper">
    <div class="dashboard-header">
        <h1>🎨 Studio Dashboard - <?php echo e(auth()->user()->name); ?></h1>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-value"><?php echo e($totalArtworks ?? 0); ?></div>
                <div class="stat-label">Total Artworks</div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo e($totalSales ?? 0); ?></div>
            ...
            <div class="stat-card">
                <div class="stat-value"><?php echo e($totalViews ?? 0); ?></div>
        ...
        <div id="inventory" class="tab-content active">
            ...
            <div class="button-group">
                ...
                <a href="<?php echo e(route('artist.artworks.index')); ?>" class="btn-action btn-action-secondary">View All Artworks</a>
            </div>

            <?php if($recentArtworks && $recentArtworks->count() > 0): ?>
                <div class="cards-grid">
                    ...
                    <div class="card">
                        <img src="<?php echo e(str_contains($artwork->image_path, 'http') ? $artwork->image_path : (str_contains($artwork->image_path, 'artworks/') ? asset('storage/' . $artwork->image_path) : asset('storage/artworks/' . $artwork->image_path))); ?>" alt="<?php echo e($artwork->title); ?>" class="card-image" onerror="this.src='https://picsum.photos/seed/<?php echo e($artwork->id); ?>/400/300'">
                        <div class="card-body">
                            <div class="card-title"><?php echo e($artwork->title); ?></div>
                            <div class="card-price">₱<?php echo e(number_format($artwork->price, 0)); ?></div>
                            <span class="card-status <?php echo e($artwork->status == 'active' ? 'status-active' : 'status-inactive'); ?>">
                                <?php echo e($artwork->status == 'active' ? 'Active' : 'Inactive'); ?>

                            </span>
                            <div style="font-size: 12px; color: #999; margin-top: 8px;">👁 <?php echo e($artwork->views); ?> views</div>
        ...
        <div id="upload" class="tab-content">
            ...
            <div class="upload-artwork-form" id="uploadForm">
                <form action="<?php echo e(route('artist.artworks.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
            ...
            <?php if($recentOrders && $recentOrders->count() > 0): ?>
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($orderItem->artwork->title ?? 'Unknown'); ?></td>
                                <td><?php echo e($orderItem->order->buyer->name ?? 'Unknown'); ?></td>
                                <td><?php echo e($orderItem->created_at->format('M d, Y')); ?></td>
                                <td>₱<?php echo e(number_format($orderItem->subtotal, 2)); ?></td>
                                <td><span class="card-status status-active">Completed</span></td>
                                <td><a href="<?php echo e(route('order.show', $orderItem->order)); ?>" class="btn-small btn-small-primary">View</a></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
            ...
            <div class="upload-artwork-form">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e(auth()->user()->name); ?>" placeholder="Your Studio/Artist Name">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel-f1-Sotto - Copy\resources\views/artist/dashboard.blade.php ENDPATH**/ ?>