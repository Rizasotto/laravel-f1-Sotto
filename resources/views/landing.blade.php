...
<section class="hero-section">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="hero-buttons">
            @auth
                <a href="{{ route('marketplace.index') }}" class="btn-hero btn-primary-hero">Browse Marketplace</a>
                @if(auth()->user()->isArtist())
                    <a href="{{ route('artist.dashboard') }}" class="btn-hero btn-secondary-hero">My Studio Dashboard</a>
                @else
                    <a href="{{ route('buyer.dashboard') }}" class="btn-hero btn-secondary-hero">My Collection</a>
                @endif
            @else
                <a href="{{ route('register') }}" class="btn-hero btn-primary-hero">Join as Artist</a>
                <a href="{{ route('login') }}" class="btn-hero btn-secondary-hero">Browse Marketplace</a>
            @endauth
        </div>
    </div>
</section>
    ...
    <div class="artworks-grid">
        ...
        @foreach($featured as $artwork)
            <div class="artwork-card">
                <img src="{{ $artwork['image'] }}" alt="{{ $artwork['title'] }}" class="artwork-image" onerror="this.src='https://picsum.photos/400/300?random=999'">
                <div class="artwork-info">
                    <div class="artwork-title">{{ $artwork['title'] }}</div>
                    <div class="artwork-artist">by {{ $artwork['artist'] }}</div>
                    <div class="artwork-rating">⭐ {{ $artwork['rating'] }} Rating</div>
                    <div class="artwork-price">₱{{ number_format($artwork['price']) }}</div>
...
<section class="promotions-section">
    ...
    <div class="promotions-grid">
        <div class="promo-card">
            ...
            <a href="{{ route('marketplace.index', ['price_range' => ['0-5000']]) }}" class="promo-btn" style="text-decoration: none; color: inherit;">Shop Now</a>
        </div>
        <div class="promo-card">
            <div class="promo-title">🎁 Bundle Deal</div>
            <div class="promo-desc">Buy 3 artworks, get 20% discount on the total price</div>
            <a href="{{ route('marketplace.index') }}" class="promo-btn" style="text-decoration: none; color: inherit;">View Bundle</a>
        </div>
        <div class="promo-card">
            ...
            <a href="{{ route('marketplace.index', ['sort' => 'newest']) }}" class="promo-btn" style="text-decoration: none; color: inherit;">Discover</a>
        </div>
    </div>
</section>
